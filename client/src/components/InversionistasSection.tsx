...
export const InversionistasSection = () => {
  ...
  return (
    <section id="inversionistas" className="py-12 sm:py-16 md:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <span className="text-primary font-bold tracking-[0.15em] uppercase text-sm mb-4 block">Inversionistas</span>
